...
import { CurriculumMapDeleteDialog } from './curriculum-map-delete-dialog';

describe('CurriculumMap Management Delete Component', () => {
  let comp: CurriculumMapDeleteDialog;
  let fixture: ComponentFixture<CurriculumMapDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CurriculumMapDeleteDialog);
