...
import { CourseScheduleDeleteDialog } from './course-schedule-delete-dialog';

describe('CourseSchedule Management Delete Component', () => {
  let comp: CourseScheduleDeleteDialog;
  let fixture: ComponentFixture<CourseScheduleDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CourseScheduleDeleteDialog);
