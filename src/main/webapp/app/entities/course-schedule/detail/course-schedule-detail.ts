...
@Component({
  ...
  selector: 'jhi-course-schedule-detail',
  templateUrl: './course-schedule-detail.html',
  imports: [FontAwesomeModule, Alert, AlertError, TranslateDirective, TranslateModule, RouterLink, FormatMediumDatetimePipe],
})
export class CourseScheduleDetail {
  readonly courseSchedule = input<ICourseSchedule | null>(null);
