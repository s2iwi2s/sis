...
import { AccountPayablesDeleteDialog } from './account-payables-delete-dialog';

describe('AccountPayables Management Delete Component', () => {
  let comp: AccountPayablesDeleteDialog;
  let fixture: ComponentFixture<AccountPayablesDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AccountPayablesDeleteDialog);
