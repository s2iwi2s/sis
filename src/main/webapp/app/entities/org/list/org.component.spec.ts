...
describe('Org Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'org', component: OrgComponent }]), HttpClientTestingModule, OrgComponent],
      providers: [
        {
  ...
  describe('trackId', () => {
    it('Should forward to orgService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrgIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrgIdentifier).toHaveBeenCalledWith(entity);
