...
export const sampleWithPartialData: IStudent = {
  ...
  middleName: 'wildly',
  lastName: 'Stokes',
  birthDate: dayjs('2026-07-04T12:22'),
  ...
  createdDate: dayjs('2026-07-04T07:46'),
  lastModifiedBy: 'yowza',
  lastModifiedDate: dayjs('2026-07-03T19:46'),
};
...
export const sampleWithFullData: IStudent = {
  ...
  lastName: 'Hagenes',
  extName: 'fuel pish',
  birthDate: dayjs('2026-07-03T16:04'),
  birthPlace: 'specific',
  ...
  createdDate: dayjs('2026-07-04T10:31'),
  lastModifiedBy: 'emulsify silky absent',
  lastModifiedDate: dayjs('2026-07-04T15:47'),
};
