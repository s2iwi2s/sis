...
import { AcademicTermsDeleteDialog } from './academic-terms-delete-dialog';

describe('AcademicTerms Management Delete Component', () => {
  let comp: AcademicTermsDeleteDialog;
  let fixture: ComponentFixture<AcademicTermsDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AcademicTermsDeleteDialog);
