...
describe('AcademicYear Management Delete Component', () => {
  let comp: AcademicYearDeleteDialog;
  let fixture: ComponentFixture<AcademicYearDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(AcademicYearDeleteDialog);
