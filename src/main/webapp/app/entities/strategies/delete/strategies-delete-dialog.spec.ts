...
import { StrategiesDeleteDialog } from './strategies-delete-dialog';

describe('Strategies Management Delete Component', () => {
  let comp: StrategiesDeleteDialog;
  let fixture: ComponentFixture<StrategiesDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(StrategiesDeleteDialog);
