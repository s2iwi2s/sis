...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../instructor.test-samples';
...
describe('Instructor Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Instructor', () => {
      ...
      service.create(instructor).subscribe(resp => (expectedResult = resp));
    ...
    it('should update a Instructor', () => {
      ...
      service.update(instructor).subscribe(resp => (expectedResult = resp));
    ...
    describe('addInstructorToCollectionIfMissing', () => {
      it('should add a Instructor to an empty array', () => {
        ...
        expect(expectedResult).toEqual([instructor]);
      });
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toEqual([instructor, instructor2]);
      });
