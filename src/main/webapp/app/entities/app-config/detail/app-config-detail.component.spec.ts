...
describe('AppConfig Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [AppConfigDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('byteSize', () => {
    it('Should call byteSize from DataUtils', () => {
      ...
      const fixture = TestBed.createComponent(AppConfigDetailComponent);
