...
import { GradeLevelPayablesDeleteDialog } from './grade-level-payables-delete-dialog';

describe('GradeLevelPayables Management Delete Component', () => {
  let comp: GradeLevelPayablesDeleteDialog;
  let fixture: ComponentFixture<GradeLevelPayablesDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(GradeLevelPayablesDeleteDialog);
