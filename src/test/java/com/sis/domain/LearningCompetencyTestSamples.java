...
public class LearningCompetencyTestSamples {
    ...
    public static LearningCompetency getLearningCompetencySample1() {
        return new LearningCompetency().id(1L).seqNo(1).competencyCode("competencyCode1").description("description1");
    }

    public static LearningCompetency getLearningCompetencySample2() {
        return new LearningCompetency().id(2L).seqNo(2).competencyCode("competencyCode2").description("description2");
    }
